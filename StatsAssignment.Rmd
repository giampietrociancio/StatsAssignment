...
The Log Return visualization do not interfere with the sign of the simple return. Whenever $0<\frac{P_t}{P_{t-1}} < 1$ both simple and log return will show a negative value; vice versa for  $\frac{P_t}{P_{t-1}} > 1$.
